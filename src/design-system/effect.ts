...
export const EffectTokens: Tokens<EffectSystem> = /* @__PURE__ */ createTokens({
  ...
  "inset-shadow-none": "inset 0 0 hsl(0 0% 0% / 0)",
  "inset-shadow-2xs": "inset 0 1px hsl(0 0% 0% / 0.05)",
  "inset-shadow-xs": "inset 0 1px 1px hsl(0 0% 0% / 0.05)",
